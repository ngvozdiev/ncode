...
class basic_json
{
    ...
    */
    ...
    basic_json(InputIT first, InputIT last) : m_type(first.m_object->m_type)
    {
        ...
        switch (m_type)
        {
            ...
            {
                assert(first.m_object != nullptr);
                LOG(FATAL) << "cannot use construct with iterators from " << first.m_object->type_name();
            }
        }
    }
  ...
  public:
    ...
    */
    ...
    {
      CHECK(is_null() || is_array()) << "cannot use operator[] with " << type_name();
    ...
    */
    ...
    {
      CHECK(is_null() || is_object()) << "cannot use operator[] with " << type_name();
    ...
    class const_iterator : public std::iterator<std::random_access_iterator_tag, const basic_json>
    {
      ...
      public:
        ...
        bool operator==(const const_iterator& other) const
        {
            ...
            CHECK (m_object == other.m_object) << "cannot compare iterators of different containers";
            assert(m_object != nullptr);
        ...
        typename object_t::key_type key() const
        {
          ...
          CHECK (m_object->is_object()) << "cannot use key() for non-object iterators";
        ...
        */
        void get_number(basic_json& result) const
        {
            ...
            if (result.m_type  == value_t::number_float)
            {
                ...
                {
                  LOG(FATAL) << std::string("parse error - ") << get_token() << " is not a number";
                }
            }
        }
